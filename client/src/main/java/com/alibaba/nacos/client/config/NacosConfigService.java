 ...
 */
/**
 * com.alibaba.nacos.client.config.NacosConfigService.java
 * @阅读人 zengmx(8574157@qq.com)
 * @阅读时间  2020/9/22 10:13
 * 实现configService接口
 */
...
public class NacosConfigService implements ConfigService {
    ...
    /**
     * @阅读人 zengmx(8574157@qq.com)
     * @阅读时间  2020/9/22 10:19
     * 构造函数分别执行几个操作
     * 1. 校验传入的properties文件 →2. 获取编码  →3. 初始化命名空间  →4. 初始化clientWorker及httpAgent
     */
